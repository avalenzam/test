...
public class OfferingsApiController {
    ...
    @ApiResponses(value = { @ApiResponse(code = 200, message = "Offerings retrieved successfully", response = ResponseType.class),
	    @ApiResponse(code = 400, message = "BAD REQUEST", response = ExceptionTypeFilter.class),
	    @ApiResponse(code = 403, message = "FORBIDDEN", response = ExceptionTypeFilter.class),
	    @ApiResponse(code = 404, message = "NOT FOUND", response = ExceptionTypeFilter.class),
	    @ApiResponse(code = 409, message = "CONFLICT", response = ExceptionTypeFilter.class),
	    @ApiResponse(code = 500, message = "INTERNAL SERVER ERROR", response = ExceptionTypeFilter.class),
	...
	try {
	    OffersBenefitsRequestDto offersBenefitsRequestDto = appRequest.fromParamstoBody(type, correlationId, name, isBundle, lifeCycleStatus,
		    ...
		    paginationInfoSize, paginationInfoPageCount, paginationInfoPage,
