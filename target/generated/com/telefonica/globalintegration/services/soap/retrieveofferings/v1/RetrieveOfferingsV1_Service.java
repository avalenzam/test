 ...
 * 2020-08-05T12:28:02.122-05:00
 * Generated source version: 3.1.15
 * 
 */
@WebServiceClient(name = "retrieveOfferings_v1", 
                  wsdlLocation = "file:/D:/proyectos/NUEVO_MOTOR/shaka-elegiblefoffers-fi/src/main/resources/wsdl/ro/v1.wsdl",
...
public class RetrieveOfferingsV1_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/proyectos/NUEVO_MOTOR/shaka-elegiblefoffers-fi/src/main/resources/wsdl/ro/v1.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RetrieveOfferingsV1_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/proyectos/NUEVO_MOTOR/shaka-elegiblefoffers-fi/src/main/resources/wsdl/ro/v1.wsdl");
        }
        WSDL_LOCATION = url;
    }
